...
from flask import abort, flash, g, redirect, render_template, request, Response, session
...
class Superset(BaseSupersetView):  # pylint: disable=too-many-public-methods
    ...
    def welcome(self) -> FlaskResponse:
        ...
        # Set role to 'sambhav' if it exists, else first role
        roles = list(payload['user']['roles'].keys())
        role = 'sambhav' if 'sambhav' in roles else roles[0]
