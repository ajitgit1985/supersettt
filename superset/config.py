...
# APP_ICON = "/static/assets/images/NER_logo.png" #nicsi_debug (commented)
...
# Custom change for periodicity functionality
TIME_GRAIN_DENYLIST: list[str] = ["P1D","P1W","PT1S", "PT1M","PT1H"]
...
# Register these custom time grain for the half yearly functionality.
TIME_GRAIN_ADDONS = {
    "P6M": "6 months",
}
...
# Define how to compute the custom time buckets added functionaliy on Periodicity for the half yearly.
TIME_GRAIN_ADDON_EXPRESSIONS = {
    'postgresql': {
        'P6M': "date_trunc('year', {col}) + (date_part('month', {col})::int / 6 * interval '6 mon')",
    },
}
