...
export default function SupersetPluginChartDemo(
  ...
  // console.log('containerSize.width 11111', width, height);
  ...
  // const fontSizeFactor = 0.01; // Adjust this factor based on your design preference
  const xsmall = `${
  ...
  console.log('sortedData: ', dataValue);
