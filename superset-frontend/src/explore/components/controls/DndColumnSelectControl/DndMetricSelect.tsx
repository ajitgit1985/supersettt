...
import { marticsTypes } from '../../../../../../superset-frontend/plugins/helpingMethoads/methods';
...
const DndMetricSelect = (props: any) => {
  ...
  const [matricsFilteredOptions, setMatricsFilteredOptions] = useState<
    Array<any>
  >([]);
  ...
  // filter the metrics values in popover box
  useEffect(() => {
    const metricsValues = props.columns.filter((col: any) =>
      marticsTypes.includes(col.type),
    );

    setMatricsFilteredOptions(metricsValues);
  }, [props.columns]);
  ...
  return (
    <div className="metrics-select">
      ...
      <AdhocMetricPopoverTrigger
        ...
        columns={matricsFilteredOptions}
