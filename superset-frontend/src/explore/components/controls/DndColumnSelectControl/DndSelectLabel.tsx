...
import { setChartData } from 'src/explore/actions/exploreActions';
  ...
  function renderGhostButton() {
    return (
      <AddControlLabel
        ...
        onClick={props.onClickGhostButton} // open the my column popup for adding the column on DIMENSIONS
      >
