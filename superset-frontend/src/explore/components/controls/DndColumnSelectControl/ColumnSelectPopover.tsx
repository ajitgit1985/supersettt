...
// superset-frontend/plugins/helpingMethoads/methods
...
const ColumnSelectPopover = ({
  ...
  const [columnFilteredOptions, setColumnFilteredOptions] = useState<any>([]);

  // filter the column values in popover box

  useEffect(() => {
    const columnValues = columns.filter((col: any) =>
