...
import { CountryMap } from '../../../../plugins/legacy-plugin-chart-country-map/src/CountryMap';
...
class Chart extends React.Component {
  ...
  render() {
    ...
    if (
      ...
      formData.extra_form_data.filters.length > 0
    ) {
      const get_formdata = formData.extra_form_data.filters[0].val;
      localStorage.setItem('formDataValue', JSON.stringify(get_formdata));
    } else {
      localStorage.clear();
    }
