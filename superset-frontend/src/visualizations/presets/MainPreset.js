...
import { LiquidChartPlugin } from 'plugins/superset-plugin-chart-liquid/src';
import { SupersetPluginChartHelloWorld } from 'plugins/superset-plugin-chart-hello-world/src';
import { SupersetPluginChartHellowWorldNew } from 'plugins/superset-plugin-chart-hellow-world-new/src';
import { SupersetPluginChartHierarchy } from 'plugins/superset-plugin-chart-hierarchy/src';
import { SupersetPluginChartDemo } from 'plugins/superset-plugin-chart-demo/src';
import { SupersetPluginChartBignumberLine } from 'plugins/superset-plugin-chart-bignumber-line/src';
import { SupersetPluginDrillDownChart } from 'plugins/superset-plugin-drill-down-chart/src';
  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new SupersetPluginChartHelloWorld().configure({ key: 'hello-world' }),
        new SupersetPluginChartHierarchy().configure({ key: 'hierarchy' }),
        new SupersetPluginChartHellowWorldNew().configure({
          key: 'new-hello-world',
        }),
        new SupersetPluginChartDemo().configure({
          key: 'SupersetPluginChartDemo',
        }),
        new SupersetPluginChartBignumberLine().configure({
          key: 'SupersetPluginChartBignumberLine',
        }),
        new SupersetPluginDrillDownChart().configure({
          key: 'SupersetPluginDrillDownChart',
        }),
      ],
    });
  }
