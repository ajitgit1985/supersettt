...
export function Menu({
  ...
  return (
    <StyledHeader className="top login_head_hide" id="main-menu" role="navigation">
      ...
      <Row>
        <Col md={16} xs={24}>  
          ...
          >
            ...
            {/* <a href="http://localhost:3000" className="navbar-brand-text hm_btn" style={{color: 'white', marginRight: '15px',paddingRight: '0px'}}>iFrame</a> */}
          </DropdownMenu>
        </Col> 
        <Col md={8} xs={24}> 
          <RightMenu
