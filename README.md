...
# Nisci Project Setup Instructions

## Clone Repository
```bash
git clone https://github.com/nicsipbd/superset3.git
...
```bash
git add .
git commit -m "Specify the code changes"
git push origin <branchname>

## Database Setup, Access the Docker Console
```bash
